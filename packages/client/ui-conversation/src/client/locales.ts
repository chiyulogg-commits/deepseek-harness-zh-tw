...
export const zhTw = {
  ...
  'image.subagentUnsupported': '子代理會話暫不支援圖片',
  ...
  'stats.ttftAverage': '首個 token 平均 {duration}',
  'stats.tokensPerSecond': '{throughput} tok/s',
  'stats.cacheHit': '快取命中 {percent}%',
  'stats.tokens': '輸入 {input} tok · 輸出 {output} tok',
  'settings.enter.title': '忙碌時 Enter 鍵行為',
  'settings.enter.description': '僅在代理執行階段生效；Cmd/Ctrl+Enter 使用另一行為',
  'settings.enter.queue': '排隊傳送',
  'settings.enter.steer': '插話傳送',
  'access.confirm.title': '確認啟用 Full access？',
  'access.confirm.description': '啟用 Full access 後，agent 將減少確認步驟，並且可以直接執行更多操作，包括敏感操作、檔案修改或外部指令。僅建議在你信任當前任務時使用。',
  ...
  'details.title': '詳情',
  'details.close': '關閉詳情',
  'details.empty': '點選訊息流中的工具列檢視詳情',
  'details.notInWindow': '該呼叫不在當前視窗內',
  'details.input': '輸入',
  'details.output': '輸出',
  'details.running': '執行中…',
  'todo.title': '任務',
  ...
  'message.compaction.completed': '已壓縮 {items} 則歷史記錄（約 {tokens} tokens）',
  'message.compaction.expand': '點選檢視壓縮摘要',
  ...
  'message.ttft': '首個 token {seconds}秒',
  'message.tokensPerSecond': '{tps} tok/s',
  'duration.seconds': '{seconds}秒',
  'duration.minutes': '{minutes}分{seconds}秒',
  'command.running': '執行中…',
  ...
  'approval.escalation': '工具 {toolName} 請求特權執行',
  'approval.reject': '拒絕',
  ...
  'search.expandAria': '展開其餘 {n} 行結果',
  'search.expand': '… 其餘 {n} 行',
  'search.summary.truncated': '顯示 {shown} / 共 {total}',
  'search.summary.paths': '{count} 個路徑',
  'search.summary.matches': '{count} 處相符 · {files} 個檔案',
  'read.count': '顯示 {shown} / {total} 行',
  'read.collapseAria': '收起內容',
  'read.expandAria': '展開其餘 {n} 行',
...
export const en = {
  ...
  'search.expandAria': 'Show {n} more result lines',
  'search.expand': '… {n} more lines',
  ...
  'read.count': 'Showing {shown} / {total} lines',
  'read.collapseAria': 'Collapse content',
  'read.expandAria': 'Show {n} more lines',
  'diff.collapseAria': 'Collapse diff',
  'diff.expandAria': 'Show {n} more diff lines',
